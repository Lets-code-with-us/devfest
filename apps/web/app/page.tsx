    ...
    <>
      <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8 py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            >
              Build Scalable Apps.{" "}
              <span className="gradient-text">Solve Real-World Problems.</span>{" "}
            ...
            >
              Join developers worldwide in building production-ready
              applications. Get evaluated on architecture, scalability, and code
              quality. Win prizes and unlock career opportunities.
            </p>
            ...
            >
              ...
              <Button className="w-full sm:w-auto">View Challenges</Button>
            </div>
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              From registration to recognition — your journey to building
      ...
      >
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Choose your domain. Solve problems that matter. Build for the real
              world.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-16 items-center">
            ...
            <div>
              ...
              <p className="text-muted-foreground text-lg mb-8 leading-relaxed">
                Most competitions test algorithms. We test engineering. Build
                applications that could ship to production, solve problems that
                companies actually face, and prove you can design systems that
                scale.
              </p>
              ...
              <div className="glass-card rounded-3xl p-8 relative overflow-hidden bg-slate-900 text-slate-100">
                ...
                <div className="font-mono text-sm space-y-2">
                  ...
                  <div>
                    ...
                    <span className="text-orange-400">ScalableService</span>{" "}
                    {"{"}
                  </div>
                  <div className="pl-4">
                  ...
                  <div className="pl-8">
                    <span className="text-cyan-400">const</span> cached ={" "}
                    <span className="text-cyan-400">await</span>{" "}
                    redis.get(req.id);
                  </div>
                  <div className="pl-8">
                    <span className="text-cyan-400">if</span> (cached){" "}
                    <span className="text-cyan-400">return</span> cached;
                  </div>
                  <div className="pl-8">
                    <span className="text-cyan-400">const</span> result ={" "}
                    <span className="text-cyan-400">await</span>{" "}
                    <span className="text-orange-400">this</span>.compute(req);
                  </div>
                  <div className="pl-8">
                    <span className="text-cyan-400">await</span>{" "}
                    redis.setex(req.id,{" "}
                    <span className="text-orange-400">3600</span>, result);
                  </div>
                  <div className="pl-8">
      ...
      <section className="py-24 md:py-32 relative bg-secondary/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
              How We <span className="gradient-text">Evaluate</span>
            </h2>
            <p className="text-muted-foreground text-lg">
              Transparent criteria reviewed by industry engineers. No black box
              scoring.
            </p>
          </div>
      ...
      <section className="py-24 md:py-32 relative bg-secondary/30 overflow-hidden">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              We judge solutions, not tools. Bring your favorite language,
              framework, and cloud provider.
            </p>
          </div>
          ...
          <p className="text-center text-muted-foreground mt-12 text-lg">
            <span className="font-mono text-primary">&gt;</span> Focus on
            solving the problem.
            <span className="font-mono text-primary ml-2">&gt;</span> Let your
            architecture speak.
          </p>
        </div>
      </section>
      ...
      <section className="py-24 md:py-32 relative">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="text-center max-w-2xl mx-auto mb-16">
            ...
            <p className="text-muted-foreground text-lg">
              Hear from developers who competed, built, and advanced their
              careers.
            </p>
          </div>
      ...
      <section id="faq" className="py-24 md:py-32 relative bg-secondary/30">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center max-w-2xl mx-auto mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-4">
        ...
        <div className="container relative z-10 mx-auto px-4 sm:px-6 lg:px-8">
          <div className="glass-card rounded-3xl p-8 md:p-16 text-center max-w-4xl mx-auto glow-effect">
            ...
            <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-10">
              Join thousands of developers competing to solve real-world
              engineering challenges. Registration closes soon — secure your
              spot today.
            </p>
            ...
            <p className="text-sm text-muted-foreground mt-8">
              Free to participate · No credit card required · Open to all skill
              levels
            </p>
          </div>
        </div>
