...
const faqs = [
  {
    ...
    answer:
      "ScaleQuest is open to developers of all experience levels worldwide. Whether you're a student, a junior developer looking to grow, or a senior engineer seeking new challenges, you're welcome to compete. All you need is a passion for building and problem-solving.",
  },
  {
    question: "What tech stack can I use?",
    answer:
      "You have complete freedom to use any programming language, framework, database, or cloud provider. We evaluate your solution's architecture, scalability, and code quality — not the specific tools you choose. React, Go, Rust, Python, AWS, GCP — it's all fair game.",
  },
  {
    question: "How long do I have to complete a challenge?",
    answer:
      "Most challenges run for 2-4 weeks, giving you ample time to design, build, and refine your solution. The exact timeline is announced at the start of each season. We recommend spending time on architecture before diving into code.",
  },
  {
    question: "How are submissions evaluated?",
    answer:
      "Submissions are evaluated by experienced industry engineers across five criteria: Architecture & Scalability (30%), Performance & Reliability (25%), Code Quality (20%), Security (15%), and Documentation (10%). You'll receive detailed feedback regardless of your final placement.",
  },
  {
    question: "Is there a registration fee?",
    answer:
      "No, participation is completely free. We believe in making opportunities accessible to all developers. Our platform is supported by hiring partners who are looking to connect with talented engineers like you.",
  },
  {
    question: "Can I participate as a team?",
    answer:
      "Currently, ScaleQuest is an individual competition to ensure fair evaluation of personal skills. However, we're exploring team challenges for future seasons. Join our Discord to stay updated on new formats.",
  },
];
